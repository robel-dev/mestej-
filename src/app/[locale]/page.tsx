...
import HeroSection from '@/presentation/components/features/hero/HeroSection';
import ProductCarousel from '@/presentation/components/features/products/ProductCarousel';
import SocialMediaPreview from '@/presentation/components/features/social/SocialMediaPreview';
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative aspect-video rounded-2xl overflow-hidden glass border border-gold/30">
            ...
            >
              {siteContent.home.video.comingSoon}
            </motion.div>
          </div>
        </div>
      </motion.section>
