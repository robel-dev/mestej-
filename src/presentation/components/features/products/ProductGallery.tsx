...
export default function ProductGallery({ language }: ProductGalleryProps) {
  ...
  const productTypes = {
    honey: {
      ...
      icon: '🍯', label: 'Honey Mead'
    },
    buckthorn: {
      color: 'from-orange-400 to-red-600',
      icon: '🌿', label: 'Buckthorn Wine'
    },
    blueberry: {
      color: 'from-blue-400 to-purple-600',
      icon: '🫐', label: 'Blueberry Reserve'
    },
  };
      ...
      <div className="max-w-7xl mx-auto">
          ...
          {products.map((product, index) => {
            ...
            return (
              <Link key={index} href={`/${language}/products`}>
                ...
                >
                  {/* Product Image */}
                  <div className="relative h-64 mb-6 rounded-xl overflow-hidden bg-gradient-to-br from-black/50 to-black/80">
                    ...
                    >
                      <span className="text-white text-sm font-medium">{siteContent.wines.clickToLearnMore}</span>
                    </motion.div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="pt-4 border-t border-gold/20 space-y-3">
                        ...
                        <div>
                          <h4 className="text-sm font-semibold text-gold mb-2">{siteContent.wines.availableAt}</h4>
                        ...
                        >
                          <span>{siteContent.wines.buyButton}</span>
        ...
        >
          <h3 className="text-2xl font-serif font-semibold golden-text mb-4">
            {siteContent.wines.fineDining.title}
          </h3>
          <p className="text-white/70 mb-8 max-w-2xl mx-auto">
            {siteContent.wines.fineDining.description}
          </p>
          ...
          >
            {siteContent.wines.fineDining.viewLocations}
          </motion.button>
        </motion.div>
      </div>
    </section>
