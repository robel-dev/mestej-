...
import { products, content } from '@/shared/constants/content';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold mb-6">
            <span className="golden-text">{siteContent.home.products.title}</span>
          </h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            {siteContent.home.products.subtitle}
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative h-[600px] rounded-3xl overflow-hidden glass border border-gold/30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full w-full p-8">
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    >
                      ...
                      <div className="relative w-48 h-96 rounded-3xl overflow-hidden shadow-2xl">
                        <img
                          src={productTypes[products[currentIndex].type as keyof typeof productTypes].templateImage}
                          alt={products[currentIndex].name}
                          className="absolute inset-0 w-full h-full object-cover object-center"
                        />
                        <div className={`absolute inset-0 bg-gradient-to-t ${productTypes[products[currentIndex].type as keyof typeof productTypes].color} opacity-50`} />
                  ...
                  <div className="flex flex-col justify-center space-y-6">
                    ...
                    <motion.div
                      ...
                      className="space-y-3"
                    >
                      <h4 className="text-lg font-semibold text-gold">{siteContent.home.products.availableAt}</h4>
                    ...
                    >
                      ...
                      >
                        <span>{siteContent.home.products.buyButton}</span>
            ...
            <div className="absolute top-4 right-4 flex items-center space-x-2 text-white/60 text-sm">
              ...
              <span>{isAutoPlaying ? siteContent.home.products.autoPlaying : siteContent.home.products.paused}</span>
            </div>
          </div>
