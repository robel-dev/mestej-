  ...
  const socialPosts = [
    {
      ...
      caption: 'Golden honey mead aging to perfection ✨🍯 #MestejWinery #HoneyMead #SwedishTradition',
      likes: 342,
      comments: 28,
      timeAgo: '2h',
      type: 'image'
    },
    {
      ...
      caption: 'Behind the scenes: Our buckthorn harvest process 🌿',
      views: '12.3K',
      likes: 892,
      timeAgo: '1d',
      type: 'video'
    },
    {
      ...
      caption: 'Blueberry wine tasting notes: Rich, fruity, with hints of Nordic forest 🫐🍷',
      likes: 567,
      comments: 45,
      timeAgo: '3h',
      type: 'image'
    },
    {
      ...
      caption: 'The art of traditional Swedish mead making 🍯✨',
      views: '8.7K',
      likes: 654,
      timeAgo: '6h',
      type: 'video'
    },
    {
      ...
      caption: 'Cheers to Swedish craftsmanship! 🥂 Available at fine restaurants across Sweden',
      likes: 789,
      comments: 67,
      timeAgo: '1d',
      type: 'image'
    },
    {
      ...
      caption: 'From hive to bottle: Our honey sourcing journey 🐝',
      views: '15.2K',
      likes: 1234,
      timeAgo: '2d',
      type: 'video'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold mb-6">
            <span className="golden-text">Follow Our Journey</span>
          </h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            Stay connected with us on social media for behind-the-scenes content, 
            wine education, and exclusive releases
          </p>
        </motion.div>
        ...
        >
          {socialPosts.slice(0, 6).map((post, index) => (
            <motion.div
              ...
              className={`relative overflow-hidden rounded-2xl glass border border-gold/30 cursor-pointer group ${
                post.platform === 'tiktok' ? 'aspect-[9/16] max-h-96' : 'aspect-square'
              }`}
